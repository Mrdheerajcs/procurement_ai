...
def scan_pdf(file_path, file_name, category, sub_category):
...
def scan_word_document(file_path, file_name, category, sub_category):
    ...
    for root, dirs, files in os.walk(base_folder):
        for file in files:
            ...
            if file.endswith(".pdf"):
                scan_pdf(file_path, file, "Past_Tenders", sub_category)
            elif file.endswith(".docx"):
                scan_word_document(file_path, file, "Past_Tenders", sub_category)
